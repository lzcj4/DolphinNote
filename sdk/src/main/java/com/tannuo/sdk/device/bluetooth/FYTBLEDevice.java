 ...
 * 飞易通
 */
public class FYTBLEDevice extends BLEDevice {
    private static final String UART_UUID = "0000fff0-0000-1000-8000-00805f9b34fb";

    public FYTBLEDevice(Context context, TouchDeviceListener listener, IProtocol protocol) {
