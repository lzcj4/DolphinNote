 ...
 */
public class PQUsbProtocol extends ProtocolBase {
    private final byte FRAME_HEADER = 0x02;
    private final byte FRAME_END = 0x06;
    ...
    private final byte ACTION_DOWN = 0x07;
    private final byte ACTION_MOVE = ACTION_NONE;
    private final byte ACTION_UP = 0x04;

    public PQUsbProtocol() {
